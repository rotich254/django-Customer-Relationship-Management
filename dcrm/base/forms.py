...
class AddRecordForm(forms.ModelForm):
    first_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Enter the First name", "class":"form-control"}), label="")
    last_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Enter the Last name", "class":"form-control"}), label="")
    ...
    email = forms.EmailField( widget=forms.widgets.EmailInput(attrs={"placeholder":"Enter the email", "class":"form-control"}), label="")
